...
export { Promisor, inlinePromisor } from "./api/Promisor";
export { Repository } from "./api/Repository";
export { OptionalType, RequiredType, isPresent, isNotPresent, hasFunctions, isString, isNumber } from "./api/Types";
...
export { PromisorFactory, CONTRACT as PROMISOR_FACTORY } from "./api/PromisorFactory";
