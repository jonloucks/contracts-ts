...
import { AtomicBoolean, LAWYER } from "@jonloucks/contracts-ts/api/auxiliary/AtomicBoolean";
import { CONTRACT as FACTORY, LAWYER as FACTORY_LAWYER } from "@jonloucks/contracts-ts/api/auxiliary/AtomicBooleanFactory";
